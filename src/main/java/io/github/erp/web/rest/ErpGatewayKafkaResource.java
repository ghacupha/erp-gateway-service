...
@RestController
@RequestMapping("/api/erp-gateway-kafka")
public class ErpGatewayKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ErpGatewayKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public ErpGatewayKafkaResource(KafkaProperties kafkaProperties) {
